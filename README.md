...
現時点では、日経平均、S&P 500、NASDAQ、ドル円、WTI原油、金を公開チャートデータから取得し、米10年金利はFREDの公開CSVから取得します。TOPIX本指数は安定取得元が未確定のため、当面は TOPIX連動ETF `1306.T` を参考値として明示し、`世界の株価と日経先物` は確認用リンクとして添えます。
